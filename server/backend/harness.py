...
from trcframe.trcframeselector import trc_frame_select
...
trc_data.load(path)  # load trc data
trcFrame = trc_frame_select(trc_data, 100)  # get marker coordinates for all frames
